      ...
      <el-col :span="spanInput">
        <el-form-item :error="amountError">
          ...
          >
            <el-input
              id="TrAmountTextBox"
              @change="$emit('AmountTextBox-onChange', this.value)"
              @blur="$emit('AmountTextBox-onBlur', this.value)"
              @keypress="$emit('AmountTextBox-onKeyPress', this.value)"
              @keyup="$emit('AmountTextBox-onKeyUp', this.value)"
              @focus="$emit('AmountTextBox-onFocus', this.value)"
              :maxlength="maxLength"
              :disabled="isDisabled"
              :style="
                'text-align-last:' +
